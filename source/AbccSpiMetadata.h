...
#define FILEVERSION_MONTH	7
#endif

#ifndef FILEVERSION_DAY
#define FILEVERSION_DAY		24
#endif
...
#define FILEVERSION_STR(x)	#x

#define ABCC_SPI_METADATA_FILEVERSION_RAW	FILEVERSION_YEAR,FILEVERSION_MONTH,FILEVERSION_DAY,FILEVERSION_BUILD
#define ABCC_SPI_METADATA_FILEVERSION		FILEVERSION_STR( (FILEVERSION_YEAR,FILEVERSION_MONTH,FILEVERSION_DAY,FILEVERSION_BUILD) )
